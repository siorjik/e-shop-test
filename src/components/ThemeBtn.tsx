...
export default function ThemeBtn() {
  ...
  const light = (
    <svg
      ...
      strokeWidth={1.5} stroke="currentColor" className="size-6" width={24} height={24}
    >
      <path
        strokeLinecap="round"
  ...
  const dark = (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
      className="size-6 fill-slate-700" width={24} height={24}
    >
      <path strokeLinecap="round" strokeLinejoin="round"
        d="
          M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753
